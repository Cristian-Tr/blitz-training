document.addEventListener('DOMContentLoaded', function () {
	...
	// Create questions
	var questions = [
		new FormatQuestion('&#9725; PREGĂTIREA VIZITEI &#9725;<br>Ce trebuie să facem înainte de a vizita o locație?', ['Curățăm pantofii', 'Memorăm o comanda valoroasă', 'Stabilim un obiectiv', 'Îi dăm telefon patronului'], 'Stabilim un obiectiv'),
		...
		new FormatQuestion('&#9725; EXPLORAREA CLIENTULUI &#9725;<br>Ce urmărim după ce am intrat în locație?', ['Câte vânzătoare are firma', 'Dacă are afișate autorizațiile', 'Dacă este aer condiționat', 'Stocul de produse și promoțiile'], 'Stocul de produse și promoțiile'),
		...
		new FormatQuestion('&#9725; CARACTERISTICILE PRODUSULUI &#9725;<br>Este clientul interesat de caracteristicile produsului?', ['Da', 'Nu', 'Doar dacă le transformăm în beneficii pt. el', 'Doar dacă îi oferim o mostră'], 'Doar dacă le transformăm în beneficii pt. el'),
		...
		new FormatQuestion('&#9725; MANEVRAREA OBIECȚIILOR &#9725;<br>Cum putem depăși o obiecție adevărată?', ['Furnizând o soluție', 'Contrazicând clientul', 'Îl rugăm să discute cu supervizorul ', 'Îl implorăm să renunțe la obiecție'], 'Furnizând o soluție'),
		new FormatQuestion('&#9725; FINALIZAREA COMENZII &#9725;<br>Când putem închide comanda?', ['După ce am revenit în mașină', 'La 5 minute după începerea discuției', 'După aprobarea supervisor-ului', 'Când primim semnale favorabile de la client'], 'Când primim semnale favorabile de la client'),
